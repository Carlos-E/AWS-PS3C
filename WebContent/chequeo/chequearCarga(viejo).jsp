...
<%
	...
	session.setAttribute("pagina", "Chequear Carga de Mercancía");
%>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
<title>Chequeo de Carga de Mercancia</title>
...
<body class="fondo">
	...
	<div class="container">
		...
		<%
				...
				if (!envios.isEmpty()) {
		%>
		<form id="form" name="form" action="/chequeoCarga" method="post">
			...
			<form id="form" name="form" action="/chequeo/chequearCarga.jsp"
