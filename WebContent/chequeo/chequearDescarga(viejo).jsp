...
<body class="fondo">
	...
	<div class="container">
		...
		<form id="form" name="form" action="/buscar" method="post" class="form-horizontal">
			<table class="table table-bordered" style="background: rgba(0, 0, 0, 0.60); color: white;">
				<thead>
					<tr>
						<div id="contact-form2">
							<span>Mercancia: </span>
							<select class="form-control" id="subject" name="chequeoDescarga" tabindex="4">
								<%
									for (int i = 0; i < listaCamiones.size(); i++) {
								%>
								<option value="<%out.print(listaCamiones.get(i).getPlaca());%>">Camion Placa :
									<%
								...
								%>
								<option value="<%out.print(listaTrailers.get(i).getPatente());%>">Trailer Patente:
									<%
		...
		<form id="form" name="form" action="/chequeoDescarga" method="post">
			<table class="table table-bordered" style="background: rgba(0, 0, 0, 0.60); color: white;">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<input name="<%out.print(envios.get(i).getFecha());%>" value="true" type="checkbox" <%out.print(chequeo);%>>
						</td>
						<%
							}
						%>
			...
			<button name="submit" id="submit" type="submit" class="btn btn-primary">Chequear</button>
		...
		<form id="form" name="form" action="/chequeo/chequearDescarga.jsp" method="post" class="form-horizontal">
			<div class="form-group">
				<label class="control-label col-sm-2" for="destino"> Este camion o trailer no contiene envios </label>
			</div>
