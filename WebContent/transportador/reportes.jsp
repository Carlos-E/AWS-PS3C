...
<body>
	...
	<div class="row">
		...
		<div class="col-md-12 col-lg-12">
			<!-- Container del mapa -->
			<div class="container">
				<iframe id="embeded" class="embed-responsive-item" frameborder="0" style="border: 0" src="https://www.google.com/maps/embed/v1/place?q=urbanizacion%20britania&key=AIzaSyCBKeFEezcbwUAD_pfyNBEXOn4xWuugg6M" allowfullscreen></iframe>
			</div>
		</div>
