...
<nav class="sidebar col-xs-12 col-sm-4 col-lg-3 col-xl-2">
				<h1 class="site-title">
					<a href="/index.jsp">
						<em class="fa fa-truck"></em> PS3C</a>
				...
				<ul class="nav nav-pills flex-column sidebar-nav">
					<li class="nav-item">
						<a class="nav-link active" href="/index.jsp">
							<em class="fa fa-tachometer-alt"></em> Inicio
							<span class="sr-only">(current)</span>
						</a>
					</li>
					<li class="parent nav-item">
						<a class="nav-link" data-toggle="collapse" href="#sub-item-1">
							<em class="fa fa-paper-plane">&nbsp;</em> Env&iacute;os
					...
					<li class="parent nav-item">
						<a class="nav-link" data-toggle="collapse" href="#sub-item-2">
							<em class="fa fa-users">&nbsp;</em> Usuarios
					...
					<li class="parent nav-item">
						<a class="nav-link" data-toggle="collapse" href="#sub-item-4">
							<em class="fa fa-truck">&nbsp;</em> Camiones
					...
					<li class="parent nav-item">
						<a class="nav-link" data-toggle="collapse" href="#sub-item-5">
							<em class="fa fa-truck">&nbsp;</em> Traileres
					...
					<li class="parent nav-item">
						<a class="nav-link" data-toggle="collapse" href="#sub-item-6">
							<em class="fa fa-check-circle">&nbsp;</em> Chequeo
						...
						<ul class="children collapse" id="sub-item-6">
							<li class="nav-item">
								<a class="nav-link" href="/asignar/carga.jsp">
									Carga
								</a>
							</li>
							<li class="nav-item">
								<a class="nav-link" href="/asignar/descarga.jsp">
									Descarga
								</a>
							</li>
						</ul>
					...
					<li class="nav-item">
						<a class="nav-link" href="mapa.jsp">
							<em class="fa fa-globe"></em> Mapa</a>
					</li>
				</ul>
				</li>
				</ul>
